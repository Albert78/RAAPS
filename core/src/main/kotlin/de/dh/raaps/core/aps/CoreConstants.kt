...
val LOW_WARNING_LOOKAHEAD = Minutes(25)
val LOW_RECOVERY_LOOKAHEAD = Minutes(30)
val BOLUS_CALCULATOR_LOW_PREDICTION_LOOKAHEAD = Minutes(30)

val LOW_BG_SAFETY_MARGIN = BgDelta.fromMgDl(5)
val LOW_TEMP_BASAL_TRIGGER = BgDelta.fromMgDl(-10)

val HIGH_CORRECTION_BOLUS_TRIGGER = BgDelta.fromMgDl(10)
val CORRECTION_ALLOWED_DROP_BELOW_TARGET = BgDelta.fromMgDl(10)