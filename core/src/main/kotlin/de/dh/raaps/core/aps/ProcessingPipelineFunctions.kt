 ...
 * to intercept the stream and perform a database insertion via the [GlucoseRepository]
 ...
 *
 * @param glucoseRepository The repository responsible for database operations.
...
fun Flow<BgReading>.persist(
    ...
    glucoseRepository.insertDataProviderGlucoseReading(reading, dataProvider, sourceSensor)
}